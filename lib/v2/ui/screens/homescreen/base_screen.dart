...
import 'package:msquare_market/v2/ui/screens/homescreen/home_screen.dart';
import 'package:msquare_market/v2/ui/screens/settings/setting_screen.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';
import 'package:get/get.dart';
import 'package:msquare_market/v2/ui/screens/super_save/dashboard/super_save_dashboard_screen.dart';
import 'package:msquare_market/v2/ui/screens/super_save/transfer_registration/nice_webview_screen.dart';
import 'package:msquare_market/v2/ui/screens/super_save/transfer_registration/transaction_registeration_main.dart';
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton(
          ...
          shape: customFABBorder(),
          backgroundColor: Colors.white,
          child: SvgPicture.asset('assets/super_save/icon.svg',
              width: 32, height: 32),
        ),
        bottomNavigationBar: Container(
          decoration: BoxDecoration(
            border: Border(
              top: BorderSide(color: greyColor20),
            ),
          ),
          // BottomNavigationBar
          child: BottomNavigationBar(
            ...
            unselectedItemColor: greyColor50,
