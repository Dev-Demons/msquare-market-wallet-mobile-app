...
import 'package:msquare_market/v2/ui/screens/swap/swapping_provider.dart';
...
class SwappingScreen extends StatefulWidget {
  /// [Constructor] that accepts the type of token for which
  /// we are going to perform transaction.

  SwappingScreen({required this.from, required this.to});
...
class _SwappingScreenState extends State<SwappingScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return ChangeNotifierProvider(
      ...
      create: (context) => SwapProvider(this.widget.from, this.widget.to),
                              ...
                              Padding(
                                ...
                                child: Text(
                                  model.state == ViewState.busy
                                      ? "..."
                                      : "${model.reversed ? model.convertToAmount : model.convertFromAmount} ${model.fromHintField}",
                                  style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                  ),
                                ),
                        ...
                        RichText(
                          text: TextSpan(
                              ...
                              children: [
                                TextSpan(
                                    text:
                                        "${model.totalGasFee!.toStringAsFixed(3)} ${model.fromHintField}",
                                    style: poppinsTextStyle(
