...
import 'package:msquare_market/v2/core/models/scan_data.dart';
    ...
    try {
      ...
      controller.scannedDataStream.listen(
        (scannedDataResult) async {
          ...
          // decode json data
          final body = json.decode(getResult);
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              launchUrl(
                                  Uri.parse(data.requestPlatform!.platformUrl!),
      ...
      content: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            GestureDetector(
              onTap: () {
                launchUrl(Uri.parse(data.requestPlatform!.platformUrl!),
                    mode: LaunchMode.externalApplication);
              },
              child: Text(
                "${data.requestPlatform!.platformUrl}",
