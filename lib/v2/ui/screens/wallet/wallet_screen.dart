...
import 'package:msquare_market/v2/ui/screens/wallet/wallet_provider.dart';
                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              "₩ " +
                                  model.locateUser.myAppUser.totalBalanceInKRW
                                      .toStringAsFixed(2),
                              style: poppinsTextStyle(
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: ListView.builder(
                        ...
                        itemCount:
                            model.locateUser.myAppUser.wallet!.tokens!.length,
                        itemBuilder: (context, index) {
                          var token =
                              model.locateUser.myAppUser.wallet!.tokens![index];
                          return CryptoWidget(
                            isHome: false,
                            token: token.name!,
                            onTap: () {},
